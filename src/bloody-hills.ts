...
export class BloodyHillsScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    addMinigameEntrances(this, {
      stageKey: 'bloody-hills',
      player: this.player,
      returnScene: 'bloody-hills',
      setStatus: (message) => {
  ...
  private createPipeShop(): void {
    this.pipeShop = new PipeShop(this, {
      stageKey: 'bloody-hills',
      roomTitle: 'Blood Pipe Room',
      player: this.player,
      pipeX: 1320,
      pipeY: 824,
      roomX: 440,
      roomY: 260,
      unlockMessage: 'Blood pipe revealed! Squat on it to enter.',
      returnMessage: 'Back from the blood pipe room.',
  ...
  private tryUseHeroAbility(): void {
    ...
    switch (this.selectedHero.specialAbility) {
      ...
      case 'FREEZE_PATCH': {
        ...
        this.statusMessage = 'Freeze Patch deployed. The whole slope goes brittle.'
      ...
      case 'MOLTEN_TRAIL': {
        ...
        this.statusMessage = 'Molten Trail ignited. The blood earth starts burning.'
